...
const CASES = [
  {slug:'atlas-foods',client:'Atlas Foods',title:'Atlas Foods: packaging that stopped the scroll',
   ...
   timeline:[['Week 1','Research and audit','Reviewed shelf competition, customer cues and current packaging hierarchy.'],['Week 2-3','Identity and packaging','Refined the visual system and built practical pack directions for retail use.'],['Week 4-5','Campaign production','Produced social, retail and launch assets from one campaign idea.'],['Week 6','Retail rollout','Prepared final files, guidance and handoff material for the launch team.']],
  ...
  {slug:'kayo-fitness',client:'Kayo Fitness',title:'Kayo Fitness: turning short video into a growth channel',
   ...
   timeline:[['Week 1','Content audit','Mapped existing posts, drop-off points and formats with the strongest buying signals.'],['Week 2','Format testing','Tested repeatable hooks and founder-led structures before scaling output.'],['Week 3-6','Production system','Built the weekly shoot, edit and caption workflow for short-form content.'],['Week 7-12','Optimization','Reviewed performance weekly and shifted production toward the formats converting best.']],
   ...
   visHTML:'<div class="vis-inner" style="background:linear-gradient(135deg,#131512,#1B1E1B 55%,#2E8F08);display:grid;place-items:center"><div style="font-family:var(--disp);font-weight:700;font-size:clamp(2.4rem,6vw,4.4rem);color:transparent;-webkit-text-stroke:1.5px #5BFA1E">growth</div></div>',
  ...
  {slug:'orbita',client:'Orbita',title:'Orbita: making a complex product easier to understand',
   ...
   timeline:[['Week 1','Messaging','Simplified the product story around use cases and buying objections.'],['Week 2','Storyboard','Built a clear visual sequence for the launch film and cut-downs.'],['Week 3-4','Production','Produced the hero video, motion loops and supporting sales clips.'],['Week 5','Launch assets','Delivered platform versions for web, paid social and sales outreach.']],
  ...
  {slug:'mona-skincare',client:'Mona Skincare',title:'Mona Skincare: performance creative that held its own in paid media',
   ...
   timeline:[['Week 1','Account audit','Reviewed spend, landing pages and creative fatigue across the ad account.'],['Week 2','Creative map','Grouped hooks by audience stage, claim type and buying intent.'],['Week 3-5','Testing sprint','Launched controlled ad tests with matched landing-page messaging.'],['Week 6+','Optimization','Shifted budget toward winners and refreshed low-performing angles.']],
  ...
  {slug:'paperplane',client:'Paperplane',title:'Paperplane: an identity system built for fundraising',
   ...
   timeline:[['Week 1','Positioning','Clarified the investor story and the brand idea behind the raise.'],['Week 2-3','Identity routes','Explored identity directions and selected a system the team could extend.'],['Week 4-5','Deck and motion','Built investor slides, motion assets and campaign-ready brand elements.'],['Week 6-8','Rollout','Packaged final files, templates and usage rules for the internal team.']],
  ...
  {slug:'encytro',client:'Encytro',title:'Encytro: a compliance site that explained trust quickly',
   ...
   timeline:[['Week 1','Messaging audit','Translated technical compliance language into buyer-facing proof points.'],['Week 2','Site map','Reworked navigation around procurement, security and demo intent.'],['Week 3-4','Copy and design','Built focused pages with clearer CTAs and less jargon.'],['Week 5','Launch','Shipped the site and handed over reusable copy blocks for sales.']],
  ...
  {slug:'my-mummy-australia',client:'My Mummy Australia',title:'My Mummy Australia: turning expertise into booked calls',
   ...
   timeline:[['Week 1','Offer review','Clarified the coaching offer and the audience pain points driving bookings.'],['Week 2','Funnel design','Built the lead magnet, webinar path and booking journey.'],['Week 3-4','Content system','Created practical post formats, captions and founder-led content templates.'],['Week 5','Launch','Connected content, signup pages and call booking into one flow.']],
  ...
  {slug:'alpmed-clinic',client:'Alpmed Clinic',title:'Alpmed Clinic: a more direct path to consultation bookings',
   ...
   timeline:[['Week 1','Discovery','Reviewed patient questions, services and the existing consultation path.'],['Week 2','Content and IA','Separated key treatments into clearer pages with trust-building content.'],['Week 3','Design','Designed service pages around clarity, reassurance and booking intent.'],['Week 4-5','Launch','Published the refreshed pages and monitored consultation flow.']],
  ...
  {slug:'pizza-hut',client:'Pizza Hut',title:'Pizza Hut: a regional campaign built around lunch urgency',
   ...
   timeline:[['Week 1','Offer planning','Defined the campaign offer and the meal occasions it needed to own.'],['Week 2','Creative production','Produced fast-read assets for social, app and local placements.'],['Week 3','Paid launch','Launched targeted creative around lunch and dinner demand windows.'],['Week 4','Iteration','Adjusted copy and placements based on order and click behavior.']],
  ...
  {slug:'waldor-watches',client:'Waldor Watches',title:'Waldor Watches: a product story with cleaner commercial intent',
   ...
   timeline:[['Week 1','Catalog review','Reviewed product pages, bundle logic and premium positioning gaps.'],['Week 2','Site and UX','Improved product hierarchy, cross-sells and buying paths.'],['Week 3-4','Content production','Created product copy and social assets around quality and gifting.'],['Week 5','Store launch','Released the refresh and tracked basket-size movement.']],
  ...
  {slug:'rock-n-rose',client:'Rock n Rose',title:'Rock n Rose: making skincare feel practical, not performative',
   ...
   timeline:[['Week 1','Audience review','Reviewed customer questions, repeat-purchase behavior and product objections.'],['Week 2','Messaging','Shifted copy toward routine, ingredients and practical benefits.'],['Week 3-4','Content rollout','Published product education across landing pages, email and social.'],['Week 5','Retention pass','Added subscription and repeat-purchase prompts at key moments.']],
  ...
  {slug:'simmons-capital',client:'Simmons Capital',title:'Simmons Capital: a clearer story for high-intent investors',
   ...
   timeline:[['Week 1','Positioning','Clarified the investment proposition and the proof points behind it.'],['Week 2','Page structure','Rebuilt the site flow around trust, process and inquiry intent.'],['Week 3-4','Design and copy','Created the refreshed site pages and investor-facing language.'],['Week 5','Launch','Published the relaunch and checked qualified inquiry paths.']],
